...
c.modules.thermostat.Thermostat("Boiler",
       ...
       temps={
                c.items.living_room_temperature: 0.20,
                c.items.office_temperature: 0.20,
                c.items.bedroom_temperature: 0.20,
                c.items.music_room_temperature: 0.10,
                c.items.entertainment_room_temperature: 0.20,
                c.items.hallway_temperature: 0.10,
           },
       humidities={
